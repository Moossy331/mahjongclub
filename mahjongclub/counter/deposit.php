<?php
    ...
    if(isset($_POST['depositSubmit'])){
        $result = deposit($_POST['userMobile'], $_POST['clubID'], $_POST['coin'], $_POST['note']);
                            ...
                            <div class="card-body">
                                <form method="POST" class="needs-validation" novalidate>
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="validationCustom03">棋牌社</label>
                                            <input type="text" class="form-control" id="validationCustom03" name="clubID" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
