<?php
    ...
    if(isset($_POST['submitInfo'])){
        $result = updateUser($_POST['userMobile'], $_POST['name'], $_POST['IDNumber'], $_POST['email'], $_POST['manage'], $_POST['note']);
        if($result == "此會員不存在！"){
    ...
    if(isset($_POST['submitNewPWD'])){
        if($_POST['newPWD'] == $_POST['againNewPWD']){
            $result = resetPassword($memberID, $_POST['newPWD']);
            if($result == "此會員不存在！"){
                echo "<script>alert('{$result}')</script>";
            }else{
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class=" row align-items-center">
                                                    <div class="form-group col-sm-6">
                                                        <label for="fname">手機號：</label>
                                                        <input type="text" class="form-control" id="fname" name="userMobile"
                                                        placeholder="">
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label for="uname">身份證號後四碼：</label>
                                                        <input type="text" class="form-control" id="uname" name="IDNumber"
                                                        placeholder="可用於取回密碼">
                                                    </div>
                                                    <div class="form-group col-sm-6">
